		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="logout.php" id="our-location" class="btn-success" ><?php echo $user_data['user_name']; ?></a></li>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								...
								<a href="https://www.linkedin.com/in/nikunj-patel-6569a61a2/" class="fa fa-linkedin"></a>
         	...
         	<div class="row">
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="video tutorials\java\display_video_courses.php">BOOKS</a></h3>
         				<p>
         					Here you will find all the BOOKS related to programming languages 
         					like HTML & CSS, JavaScript etc
         				</p>
         			</div>
         		</div>
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="compile.php">COMPILE</a></h3>
         				<p>
         					this is our serices theses are the services provided by us <br>this are the services provided by us
         				</p>
         			</div>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/nik.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Nik Patel</h4>
									<h4 class="team-member-designation">ceo</h4>
									<ul class="social-list">
										<li><a href="https://www.facebook.com" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
							...
							<div class="team-member text-center">
								<img src="img/niku.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Niku Patel</h4>
							...
							<div class="team-member text-center">
								<img src="img/nikunj.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Nikunj Patel</h4>
							...
							<div class="team-member text-center">
								<img src="img/oggy.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Oggy</h4>
									<h4 class="team-member-designation">Sr. Developer</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
							...
							<div class="team-member text-center">
								<img src="img/oggy.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">MR</h4>
									<h4 class="team-member-designation">ceo</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												E Learning is an online E-learning website <br>
